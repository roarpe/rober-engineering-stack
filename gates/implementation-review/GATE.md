...
4. Para cada hallazgo, registrar:
   - Finding ID.
...
5. Verificar que no hay desviaciones arquitectonicas importantes sin ADR.
6. Producir el artefacto de salida con la decision PASS o FAIL.
